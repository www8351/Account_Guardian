...
| קובץ | תפקיד |
| --- | --- |
| `README.md` | רקע קבוע. משתנה רק בשינוי כיוון |
| `STATUS.md` | מצב נוכחי, פתוחים, חסמים |
| `PROGRESS.md` | יומן מתוארך של מה שנעשה |
| `DECISIONS.md` | יומן החלטות ומה נדחה |
| `CLAUDE.md` | פרוטוקול העבודה |
